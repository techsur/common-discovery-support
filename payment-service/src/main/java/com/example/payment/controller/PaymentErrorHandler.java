...
import com.example.payment.client.RemoteServiceException;
...
public class PaymentErrorHandler {
    ...
    ResponseEntity<ErrorResponse> handleUnexpected(Exception exception, HttpServletRequest request) {
        return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Unexpected error while processing payment", request);
    }
